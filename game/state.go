...
type State interface {
	...
	PressNumBtn(s *discordgo.Session, r *discordgo.MessageReaction, num int)

	// PressDisBtn 사용자가 버려진 카드 이모티콘을 눌렀을 때 state에서 하는 동작
	PressDisBtn(s *discordgo.Session, r *discordgo.MessageReaction)

	// PressYesBtn 사용자가 yes 이모티콘을 눌렀을 때 state에서 하는 동작
	PressYesBtn(s *discordgo.Session, r *discordgo.MessageReaction)

	// PressNoBtn 사용자가 No 이모티콘을 눌렀을 때 state에서 하는 동작
	PressNoBtn(s *discordgo.Session, r *discordgo.MessageReaction)
	...
	filterReaction(s *discordgo.Session, r *discordgo.MessageReaction) bool
}
